...
def columna_image_hx_sismo(nuevo,image_slots, idioma):
    if idioma== 'en':

        figura = "Figure 23. Column with the greatest horizontal displacement X due to earthquake load"
    else:
        figura = "Figura 23. Columna con mayor desplazamiento horizontal X por carga de sismo"
