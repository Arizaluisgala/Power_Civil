...
def columna_image_hz_sismo(nuevo,image_slots, idioma):
    if idioma== 'en':

        figura = "Figure 24. Column with the greatest horizontal displacement Z due to earthquake load"
    else:
        figura = "Figura 24. Columna con mayor desplazamiento horizontal Z por carga de sismo"
