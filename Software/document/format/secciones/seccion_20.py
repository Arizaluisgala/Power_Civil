...
def columna_image_hz_viento(nuevo,image_slots, idioma):
    if idioma== 'en':

        figura = "Figure 22. Column with the greatest horizontal displacement Z due to wind load"
    else:
        figura = "Figura 22. Columna con mayor desplazamiento horizontal Z por carga de viento"
